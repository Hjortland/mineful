...
let resourcesArray = [
  {
    img: detectorImg,
    x: Math.floor(
      Math.random() * (canvas.width * 1.5 - canvas.width + 1) + canvas.width
    ),
    y: Math.floor(Math.random() * (canvas.height - detectorHeight - 0 + 1) + 0),
    width: detectorWidth,
  ...
  },
  {
    img: bitcoinImg,
    x: Math.floor(
      Math.random() * (canvas.width * 1.25 - canvas.width + 1) + canvas.width
    ),
    y: Math.floor(Math.random() * (canvas.height - bitcoinHeight - 0 + 1) + 0),
    width: bitcoinWidth,
  ...
  },
  {
    img: therapyImg,
    x: Math.floor(
      Math.random() * (canvas.width * 1 - canvas.width + 1) + canvas.width
    ),
    y: Math.floor(Math.random() * (canvas.height - therapyHeight - 0 + 1) + 0),
    width: therapyWidth,
    height: therapyHeight,
  },
  {
    img: chocolateImg,
    x: Math.floor(
    ...
    y: Math.floor(
      Math.random() * (canvas.height - chocolateHeight - 0 + 1) + 0
    ),
    width: chocolateWidth,
...
let dangerArray = [
  {
    ...
    y: Math.floor(Math.random() * (canvas.height - landmineHeight - 0 + 1) + 0),
    width: landmineWidth,
    height: landmineHeight,
  },
  {
    img: landminesImg,
    x: Math.floor(
    ...
    y: Math.floor(
      Math.random() * (canvas.height - landminesHeight - 0 + 1) + 0
    ),
    width: landminesWidth,
    height: landminesHeight,
  },
];
...
function moveMinesweeperX() {
  if (
    minesweeperStartX + minesweeperMoveX >= 0 &&
    minesweeperStartX + minesweeperMoveX <= canvas.width - minesweeperWidth
  ) {
...
function moveMinesweeperY() {
  if (
    minesweeperStartY + minesweeperMoveY >= 0 &&
    minesweeperStartY + minesweeperMoveY <= canvas.height - minesweeperHeight
  ) {
...
function drawResource() {
  resourcesArray.forEach(resource => {
    ...
    if (resource.x < 0) {
      resource.x = Math.floor(
        Math.random() * (canvas.width * 3 - canvas.width * 2 + 1) +
          canvas.width * 2
      );
    }
    if (
      resource.x < minesweeperStartX + minesweeperWidth - 40 &&
      resource.x > minesweeperStartX &&
      resource.y < minesweeperStartY - 40 &&
      resource.y > minesweeperStartY + minesweeperHeight
    ) {
      resource.x = Math.floor(
        Math.random() * (canvas.width * 3.5 - canvas.width * 2.5 + 1) +
          canvas.width * 2.5
      );
    }
    if (
      (resource.img === detectorImg ||
        bitcoinImg ||
        therapyImg ||
        chocolateImg) &&
      healthCounter < 3
...
function drawDanger() {
  dangerArray.forEach(danger => {
    ...
    if (danger.x < 0) {
      danger.x = Math.floor(
        Math.random() * (canvas.width * 1.75 - canvas.width + 1) + canvas.width
      );
    }
    if (
      danger.x < minesweeperStartX + minesweeperWidth - 40 &&
      ...
      if (healthCounter < 0) {
        danger.x = Math.floor(
          Math.random() * (canvas.width * 3 - canvas.width * 1.5 + 1) +
            canvas.width * 1.5
        );
        isGameOver = true;
      } else {
  ...
  resourcesArray = [
    {
      ...
      y: Math.floor(
        Math.random() * (canvas.height - detectorHeight - 0 + 1) + 0
      ),
      width: detectorWidth,
      height: detectorHeight,
    },
    {
      ...
      y: Math.floor(
        Math.random() * (canvas.height - bitcoinHeight - 0 + 1) + 0
      ),
      width: bitcoinWidth,
      height: bitcoinHeight,
    },
    {
      ...
      y: Math.floor(
        Math.random() * (canvas.height - therapyHeight - 0 + 1) + 0
      ),
      width: therapyWidth,
      height: therapyHeight,
    },
  ...
  dangerArray = [
    {
      ...
      y: Math.floor(
        Math.random() * (canvas.height - landmineHeight - 0 + 1) + 0
      ),
      width: landmineWidth,
      height: landmineHeight,
    },
